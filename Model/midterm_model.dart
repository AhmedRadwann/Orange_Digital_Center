class midterm_model {
  ...
  midterm_model({this.code, this.message, this.data});

  midterm_model.fromJson(Map<String, dynamic> json) {
    code = json['code'];
...
class Data {
  ...
  Data({this.id, this.examSubject, this.examDate, this.examStartTime, this.examEndTime, this.Final});
